    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainersDetails", x => x.TrainerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingPeriod = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentsDetails", x => x.AppointmentId);
                    table.ForeignKey(
                        name: "FK_AppointmentsDetails_TrainersDetails_TrainersTrainerId",
                        column: x => x.TrainersTrainerId,
                        principalTable: "TrainersDetails",
                        principalColumn: "TrainerId");
                });

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentsDetails_TrainersTrainerId",
